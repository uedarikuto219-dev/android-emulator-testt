...
RUN sdkmanager "emulator" "platform-tools" "platforms;android-34" "system-images;android-34;google_apis;x86_64"

RUN echo "no" | avdmanager create avd -n WideEmu -k "system-images;android-34;google_apis;x86_64" --force
